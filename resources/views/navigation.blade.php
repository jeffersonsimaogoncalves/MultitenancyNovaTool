@if (Auth::user()->can('viewAny', app(\JeffersonSimaoGoncalves\Multitenancy\Multitenancy::class)->getTenantClass()))
    <router-link tag="h3" :to="{name: 'index', params: {resourceName: 'tenants'}}"
